...
file = open(f"frames/frames.txt", "w") #here put your path to the frames
file.write("")
file.close()
file = open(f"frames/frames.txt", "a", encoding='utf8') #here put your path to the frames
...
while running:
    ...
    if num == 2192:
        ...
        exit()
        num = 0
    background_image = pygame.image.load(f"frames/frame{num}.png").convert() #here put your path to the frames
    file.write(str(num))
